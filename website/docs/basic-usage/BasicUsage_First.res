    ...
    <Box maxW=[xs(320->#px)] width=[xs(100.0->#pct)]>
      ...
      <Box>
        <Input
          ...
          onChange={e => form.handleChange(Name, (e->ReactEvent.Form.target)["value"])}
        />
      ...
      <Box mt=[xs(1)]>
        <Input
          ...
          onChange={e => form.handleChange(Email, (e->ReactEvent.Form.target)["value"])}
        />
      ...
      <Box mt=[xs(1)]>
        <Input
          ...
          onChange={e => form.handleChange(Password, (e->ReactEvent.Form.target)["value"])}
        />
      ...
      <Box mt=[xs(1)]>
        <Button onClick={_ => form.submit()}> {"Submit"->React.string} </Button>
      </Box>
    </Box>
  </Box>
}
