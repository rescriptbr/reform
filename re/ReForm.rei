...
module Create:
  (Config : Config) => {
                         ...
                         module Field:
                           {
                             let getFieldLens:
                               (Config.fields) =>
                               (Config.fields, (Config.state) => value,
                               (Config.state, value) => Config.state);
                             let validateField:
                               (Config.fields, values, value, schema,
                               Validation.I18n.dictionary) => option(string);
                             let handleChange:
                               ((Config.fields, value), values) => values;
                           };
                         type onSubmit = {
                           values: values,
                         ...
                         type reform = {
                           ...
                           getErrorForField:
                             (Config.fields) => option(string),
                         };
                         let component:
                           ReasonReact.componentSpec
                           (state,  ReasonReact.stateless, 
                         ...
                         let make:
                           ...
                           ReasonReact.componentSpec
                           (state,  state,  ReasonReact.noRetainedProps, 
                             ReasonReact.noRetainedProps,  action);
                       };
