...
function PostAddNext(Props) {
  var match = Curry._3(PostAddMutation[/* use */0], undefined, undefined, /* () */0);
  ...
  var mutate = function (variables) {
    return Curry._3(postMutation, Caml_option.some(variables), undefined, /* () */0);
  };
  var match$2 = Curry._5(PostAddForm[/* use */6], /* record */[
        /* description */"",
        /* title */"",
        /* acceptTerms */false
      ], /* Schema */[/* array */[
          ...
          var variables = make(state[/* values */1][/* description */0], state[/* values */1][/* title */1], /* () */0).variables;
          mutate(variables).then((function (result) {
  ...
  var submit = match$2[/* submit */7];
  var handleChange = match$2[/* handleChange */2];
  var getFieldState = match$2[/* getFieldState */1];
  var state = match$2[/* state */0];
  if (result !== undefined) {
    var match$3 = result;
    if (typeof match$3 === "number") {
      switch (match$3) {
        case 0 : 
            return React.createElement("p", undefined, "Something Loading...");
        case 1 : 
            return React.createElement("p", undefined, "Something Called...");
        case 2 : 
    ...
    var match$4 = state[/* formState */0] === /* Submitting */1;
                ...
                onSubmit: (function ($$event) {
                    ...
                    return Curry._1(submit, /* () */0);
                        ...
                        onChange: (function (param) {
                          ...
                          })), React.createElement("p", undefined, Belt_Option.getWithDefault(__x$6, ""))), match$4 ? React.createElement("p", undefined, "Saving...") : React.createElement("button", {
                      type: "submit"
                    }, "Submit"));
  }
}
